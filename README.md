...
| Atualização automática de cinco minutos | `tests/presentation/test_app_controller.py::{test_controller_timer_refreshes_idle_pages_after_initialization,test_controller_timer_skips_active_mutation}` |
